    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            sortedIntCollections.Add(new MySearchTree<int>());
            ...
            sortedStringCollections.Add(new MySearchTree<string>());
            ...
            sortedPlayersCollections.Add(new MySearchTree<Player>());
            ...
            */
            AddTimeTrials(rng, "\nSortedLL - Improved", sortedIntCollections[2].Add, sortedIntCollections[2].Clear, 20000);
            AddTimeTrials(rng, "\nSearch Tree", sortedIntCollections[3].Add, sortedIntCollections[3].Clear, 20000);
            Console.WriteLine("\n" + "".PadLeft(40, '-'));
        ...
        /// </summary>
        private static void TestLinkedList(ILinkedList<int> linkedList)
        {
            Console.WriteLine("\n" + "".PadLeft(40, '-'));
            ...
            // Clear to be safe
            linkedList.Clear();
            Console.WriteLine($"\nCleared: {linkedList.Count} elements - First: {linkedList.First} Last: {linkedList.Last}");
